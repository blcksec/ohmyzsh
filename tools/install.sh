...
#   sh -c "$(curl -fsSL https://raw.githubusercontent.com/blcksec/ohmyzsh/master/tools/install.sh)"
# or via wget:
#   sh -c "$(wget -qO- https://raw.githubusercontent.com/blcksec/ohmyzsh/master/tools/install.sh)"
# or via fetch:
#   sh -c "$(fetch -o - https://raw.githubusercontent.com/blcksec/ohmyzsh/master/tools/install.sh)"
#
...
#   REPO    - name of the GitHub repo to install from (default: blcksec/ohmyzsh)
...
supports_hyperlinks() {
  ...
  # https://github.com/blcksec/ohmyzsh/issues/10964
